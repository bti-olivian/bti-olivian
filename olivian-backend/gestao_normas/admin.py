...
# 1. PRIMEIRO, defina o Inline para Comentários
class ComentarioInline(admin.TabularInline):
    model = Comentario
    extra = 1 # Mostra um campo para adicionar um novo comentário por padrão
...
class NormaClienteAdmin(admin.ModelAdmin):
    ...
    inlines = [ComentarioInline] # Agora o Python já sabe o que é ComentarioInline

# Outras classes Admin (a ordem delas não importa)
